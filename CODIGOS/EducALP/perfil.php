...
?>
              ...
              <link rel="stylesheet" href="css/esperfil.css">
...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" target="_blank" href="muro.php">
                  <img src="images/alp.jfif" height="" alt="600px" width="60px">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="ml-auto navbar-nav text-uppercase">
                    <li class="nav-item active">
                        <a class="nav-link p-3" href="#">Inicio <span class="sr-only"></span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link p-3" href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">Sobre Nosotros</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link p-3" href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">Contactanos</a>
                    </li>
                   
                    <li class="nav-item">
                        <a class="nav-link p-3" href="https://bootstrap.news/bootstrap-4-template-news-portal-magazine/">Sugerencias</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-3 pr-md-4">
                <div class="sidebar-left">
                    ...
                    <ul class="list-unstyled sidebar-menu pl-md-2 pr-md-0">
                        ...
                        <li>
                            <a class="sidebar-item d-flex justify-content-between align-items-center" href="http://localhost/sistema/?controlador=empleados&accion=inicio">
                        ...
                        <li>
                            ...
                            <a class="sidebar-item d-flex justify-content-between align-items-center" href="configperfil.php"  href="configperfil.php">
                                Configuracion del perfil
                                <span class="fas fa-cog"></span>
                            </a>
                        </li>
                        <li>
                            <a class="sidebar-item d-flex justify-content-between align-items-center" href="cerrar_sesion.php" >
                               Cerrar sesion 
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 ml-auto mr-auto">
                                               <div class="profiles p-3 my-4 rounded text-center shadow-sm">
                                                    <div class="avatars">
                                                        <a href="# ">
                                                            <img width="150" height="200" id="perfil" src="img/perfil.png" alt="Circle Image" class="avatar-lg rounded-circle img-fluid" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Edit avatar images">
                                                        </a>
                                                    </div>
                                                    <div class="names">
                                                        <h3 class="title text-light"><?php echo $_SESSION['nombre']; 
                                                        echo " "; 
...
<style type="text/css">
  ...
  .btn_perfil:hover{
    ...
    background-color: #ffffff;
                                                    ...
                                                    .php"> 
                                                        <input class="btn_perfil" type="submit" name="btn_perfil" value="Editar Nombre">
                                                    </form>    
           ...
           <?php
            if(isset($_POST['btn_perfil'])){
                ...
                $consulta3 = mysqli_query($conexion,"SELECT * FROM `usuarios` WHERE `id_user` = '$id'") or die ($conexion."Problemas en la consulta");
                
                 // Verificar resultado
                  $numero3 = mysqli_num_rows($consulta3);
                
                 if($numero3 > 0){
                      while ($fila3 = mysqli_fetch_array($consulta3)){
                ?>
                <h2>Modificar Tu Nombre</h2>
                <br />
            <form action="perfil_modificar.php" method="post">
                <label>Nombres</label><br>
                 <input type="text" name="nombre" value="<?php echo $fila3['nombre']; ?>"  /> <br />
                 <label>Apellidos</label><br>
                 <input type="text" name="apellido" value="<?php echo $fila3['apellido']; ?>" /> <br />

                
                 <br />
                 <input type="text" name="id_user" value="<?php echo $fila3['id_user']; ?>" readonly hidden />
                 <input type="submit" name="btn_perfil_modificar" value="modificar datos" />
             </form>
